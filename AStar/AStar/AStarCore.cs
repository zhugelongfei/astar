...
namespace AStar
{
    public class AStarCore
    {
        ...
        //对象池
        private SimpleObjectPool<Node> nodePool = new SimpleObjectPool_DefaultCreateItemFunction<Node>(int.MaxValue);
        private SimpleObjectPool<Point2> pointPool = new SimpleObjectPool_DefaultCreateItemFunction<Point2>(int.MaxValue);
